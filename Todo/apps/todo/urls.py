...
urlpatterns = [
    ...
    path('mixins', views.TodoListMixinApiView.as_view(), name='all_todos_mixin'),
    path('mixins/<int:pk>', views.TodoDetailMixinApiView.as_view(), name='todo_detail_mixin'),
    path('generics', views.TodoListGenericApiView.as_view(), name='all_todos_generic'),
    ...
    path('user', views.UserListGenericApiView.as_view(), name='user'),
]
